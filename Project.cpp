...
void Payment()
{
	...
	{
	phoneCheck:
		cout << "\n\n\t\t\t\t\tEnter VodafoneCash Mobile Account Number: ";
		cin >> accNum;
	...
	{
		cout << "\n\n\t\t\t\t\tEnter InstaPay Mobile Account Number: ";
		cin >> accNum;
...
void iniTrain()
{
	availTrains[0].TName = "Delta Express";
	availTrains[0].TID = "SHE753";
	availTrains[0].TSource = "Obour";
	availTrains[0].TDest = "Matrouh";
	availTrains[0].TDate = "5-Jan-2025";
	...
	availTrains[1].TName = "Domyat Express";
	availTrains[1].TID = "DDO694";
	availTrains[1].TSource = "Domyat";
	availTrains[1].TDest = "Mansora";
	availTrains[1].TDate = "8-Jan-2025";
	...
	availTrains[2].TName = "Green Bus Express";
	availTrains[2].TID = "GLE400";
	availTrains[2].TSource = "6 october";
	availTrains[2].TDest = "Giza";
	...
	availTrains[3].TName = "Green Bus Express";
	availTrains[3].TID = "GHA123";
	availTrains[3].TSource = "Nasr City";
	availTrains[3].TDest = "6 october";
	availTrains[3].TDate = "08-Jan-2025";
	...
	availTrains[4].TName = "Korba Express";
	availTrains[4].TID = "KHE123";
	availTrains[4].TSource = "Korba";
	availTrains[4].TDest = "Giza";
	availTrains[4].TDate = "12-Jan-2025";
...
void trainPrice()
{
	...
	cout << "\t\t\t\t\t1. Economy \t\t 300 L.E \n";
	cout << "\t\t\t\t\t2. AC Lower \t\t 400 L.E \n";
	cout << "\t\t\t\t\t3. AC Business \t\t 550 L.E \n\n";
	cout << "\t\t\t\t\t Choice (1-3): ";
	cin >> choice;
	if (choice == 1) 
    {
...
nicCheck:
	...
	if (NIC.length() != 14 || NIC.length() > 14)
	{
		cout << endl;
		cout << "\t\t\t\t\tEnter a Valid 14 digit National ID Number!" << endl << endl;
		goto nicCheck;
	}
...
void addTrains()
{
	...
	do {
		...
		cin >> availTrains[noOfTrains].TName;
		cout << "\t\t\t\t\tEnter Train ID: ";
		cin >> availTrains[noOfTrains].TID;
		cout << "\t\t\t\t\tEnter Train Source: ";
		cin >> availTrains[noOfTrains].TSource;
		cout << "\t\t\t\t\tEnter Train Destination: ";
		cin >> availTrains[noOfTrains].TDest;
		cout << "\t\t\t\t\tEnter Train Departure Date: ";
		cin >> availTrains[noOfTrains].TDate;
		cout << "\t\t\t\t\tEnter Train Departure Time [HH:MM (MM:HH AM/PM)]: ";
		cin >> availTrains[noOfTrains].departTime;
		cout << "\t\t\t\t\tEnter Train Arrival Time [HH:MM (MM:HH AM/PM)]: ";
		cin >> availTrains[noOfTrains].arriveTime;
		cout << "\t\t\t\t\tEnter Available Train Classes: ";
		cin >> availTrains[noOfTrains].TClasses;
...
login:
	...
	if (user == "Admin" && password == "12345" || user == "admin" && password == "12345")
	{
...
//=======================================================================================================
// Welcome Screen => in Main function 
int main()
{
	iniTrain();
relog:
    ...
    cout << "\t\t\t\t\t-----------------------------------"; Sleep(500);
	cout << "\n\t\t\t\t\t\tProject Prepared by "; Sleep(600);
	cout << "\n\t\t\t\t\t-----------------------------------"; Sleep(700);
    cout << "\n\t\t\t\t              NAME                      ID"; Sleep(300);
	cout << "\n\t\t\t\t     Youssef Mohamed Elmeligy       223102754"; Sleep(500);
	cout << "\n\t\t\t\t     Hady Mohamed Mossalam          223100836"; Sleep(500);
    cout << "\n\t\t\t\t     Ammar Ramadan AbiZaid          223102176"; Sleep(500);
	cout << "\n\t\t\t\t     Judy Amr Sharaawy              223102556"; Sleep(500);
	cout << "\n\t\t\t\t     Deema Mohamed Ibrahim          223102742"; Sleep(500);
    cout << "\n\t\t\t\t     Batool Aymen AboZaid           223103395"; Sleep(500);
    cout << "\n\t\t\t\t     Abdelrahman Mohamed Negm       222200016"; Sleep(500);
	cout << endl;
	system("cls");
log:
